...
Cl_GE_memberships_disc=ClustersMembers(cl_GEx_CEx_Z, clusters_number = i_list$CEx, clusters_centroids = -cl2$centers)
# Select the Genes that show a minmem0.3 in their own cluster
minmemGEx=0.3   # Set the minimum membership threshold
Cl_GE_membersonly_conc=MembersOnly(Cl_GE_memberships_conc, clusters_number = i_list$CEx, minmem =minmemGEx)
Cl_GE_membersonly_disc=MembersOnly(Cl_GE_memberships_disc, clusters_number = i_list$CEx, minmem =minmemGEx)
